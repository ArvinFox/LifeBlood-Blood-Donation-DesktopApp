...
class UserRoutes{
  static Map<String, WidgetBuilder> routes = {
    // '/dashboard': (context) => MainLayoutScreen(child: Dashboard()),
    '/donors': (context) => MainLayoutScreen(child: DonorsPage()),
    '/request-donors':(context) => MainLayoutScreen(child: RequestDonorsPage()),
    '/events': (context) => MainLayoutScreen(child: EventsScreen()),
    '/rewards' : (context) => MainLayoutScreen(child: Rewardscreen()),
    '/medical-reports': (context) => MainLayoutScreen(child: MedicalReportsPage()),
  };
}